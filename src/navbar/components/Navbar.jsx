...
const Navbar = () => {
  ...
  return (
      <div className="fixed h-15 px-3 w-screen bg-gradient-to-b from-[#FF85A1] to-[#FFD1DC] z-[1001]">
        ...
        <div className="relative w-full items-center max-w-[400px]" ref={searchDropdownRef}>
          <input
            type="text"
            value={searchQuery}
          ...
          <div ref={dropdownRef}>
            {isDropdownOpen && (
                <div className="absolute right-0 w-48 bg-gradient-to-t from-[#FF85A1] to-[#FFD1DC] text-white text-10px sm:text-[15px] text rounded-b-lg shadow-lg">
                  <ul>
                    <li className="px-4 py-2 hover:bg-[#FFD1DC] cursor-pointer" onClick={() => alert("/profile")}>
                      Profile
                    </li>
                    <li className="px-4 py-2 hover:bg-[#FFD1DC] cursor-pointer" onClick={() => alert("/settings")}>
                      Settings
                    </li>
                    <li className="px-4 py-2 hover:bg-[#FFD1DC] cursor-pointer" onClick={() => alert("Logged out!")}>
                      Logout
                    </li>
                  </ul>
                </div>
