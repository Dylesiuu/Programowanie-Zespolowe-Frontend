const RemoveFavouriteWarning = ({ onConfirm, onCancel, animalName }) => {
  return (
      ...
      <div className="bg-[#fefaf7] rounded-xl shadow-xl max-w-md w-full p-6 mx-4">
        <div className="text-center">
          ...
          <p className="text-lg text-gray-600 mb-6">
            Czy na pewno chcesz usunąć {animalName} z listy ulubionych zwierząt?
          </p>
        </div>
...
export default RemoveFavouriteWarning;
